...
import { Search, Filter, ArrowUpDown, ChevronLeft, ChevronRight, Edit2, Trash2 } from "lucide-react";
...
export default function DevicesPage() {
  const { data: Devices, isLoading: isDevicesLoading, del, refetch } = useApi("Device");
